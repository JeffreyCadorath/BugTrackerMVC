...
namespace BugTrackerProject.Controllers
{
    public class TicketStatusController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Completion")] TicketStatus ticketStatus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Completion")] TicketStatus ticketStatus)
        {
            if (ModelState.IsValid)
            {
