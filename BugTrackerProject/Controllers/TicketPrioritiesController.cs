...
namespace BugTrackerProject.Controllers
{
    public class TicketPrioritiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Priority")] TicketPriority ticketPriority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Priority")] TicketPriority ticketPriority)
        {
            if (ModelState.IsValid)
            {
